...
# Load data
data = pd.read_csv('/Users/dominik/Downloads/egoexo4d/oldTrajectory/closed_loop_trajectory.csv')
data = data[['tx_world_device', 'ty_world_device', 'tz_world_device', 'angular_velocity_x_device', 'angular_velocity_y_device', 'angular_velocity_z_device']]
#take only 1 10th of the data
data = data[::10]
...
# Apply DBSCAN
dbscan = DBSCAN(eps=1, min_samples=10)  # Adjust these parameters based on your data
